...
import com.theotherworldly.clayworld.world.gen.ModBiomeGeneration;
...
@Mod(ClayWorld.MOD_ID)
public class ClayWorld
{
    public static final String MOD_ID = "clayworld";
